package com.github.azm11.groovy
...
/*
Each closure can be delegated to some other object ->
What it means: When we will be executing the the Pipeline closure, then
Eg. Environment is method call with a closure param. So when we delegate it to DSL
that environment closure will search for environment method in the pipelineDal ->
It will find and call the method on our delegate object
*/
